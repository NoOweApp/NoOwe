...
import { Avatar, Button, Divider, Icon, IconButton, Text, useTheme } from "react-native-paper";
...
function SectionHeader({ icon, label, theme }: { icon: string; label: string; theme: ReturnType<typeof useTheme> }) {
    return (
            ...
            >
                ...
                >
                    ...
                    <ScrollView showsVerticalScrollIndicator={false}>
                        ...
                        {/* People */}
                        <SectionHeader icon="account-group" label={`People (${people.length})`} theme={theme} />
                        ...
                        {/* Items */}
                        <SectionHeader icon="format-list-bulleted" label={`Items (${items.length})`} theme={theme} />
                                ...
                                >
                                    <View style={{ flex: 1, marginRight: 12 }}>
                                        ...
                                        <View style={{ flexDirection: "row", alignItems: "center", gap: 4, marginTop: 3 }}>
                                            <Icon source="account" size={12} color={theme.colors.onSurfaceVariant} />
                                            <Text
                                                variant="bodySmall"
                                                style={{ color: theme.colors.onSurfaceVariant }}
                                            >
                        ...
                        >
                            {[
                                { icon: "tag-outline", label: "Subtotal", value: itemsSubtotal },
